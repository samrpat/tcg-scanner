...
export default function Capture() {
  ...
  return (
    <>
      ...
      <Hint>
        The workbench: choose a camera, upload a file, or fix a crop by hand. To work
        through a pile quickly, use <strong>Scan</strong> on a phone instead.
      </Hint>
          ...
          {!secureContext ? (
            <div className="camera-fallback">
              ...
              <p className="note">
                ...
                same shutter. If that address does not load, the server has no certificate
                yet: whoever runs it needs to generate one.
              </p>
            </div>
          ) : cameraError ? (
            <div className="camera-fallback">
