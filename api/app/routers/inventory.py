        ...
        rows.append(
            {
                ...
                # How many extra shots this card carries, so the batch screen can show them
                # without guessing at URLs that would 404 on the cards that have none.
                "extras": sum(1 for kind in EXTRA_KINDS if kind in by_kind),
                "value": value.as_dict(),
            }
        )
