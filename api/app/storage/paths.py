...
_FILENAMES: dict[ImageKind, str] = {
    ...
    ImageKind.EXTRA_1: "extra-1.jpg",
    ImageKind.EXTRA_2: "extra-2.jpg",
    ImageKind.EXTRA_3: "extra-3.jpg",
}

# The extra shots, in the order they are offered and exported.
EXTRA_KINDS: tuple[ImageKind, ...] = (
    ImageKind.EXTRA_1,
    ImageKind.EXTRA_2,
    ImageKind.EXTRA_3,
)
